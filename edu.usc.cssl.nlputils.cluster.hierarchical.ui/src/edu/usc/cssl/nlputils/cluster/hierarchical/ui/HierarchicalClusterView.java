package edu.usc.cssl.nlputils.cluster.hierarchical.ui;
...
import edu.usc.cssl.nlputils.cluster.hierarchical.services.HierarchicalClusterAnalysis;
import edu.usc.cssl.nlputils.cluster.hierarchical.ui.internal.HeirarchicalClusterViewImageRegistry;
import edu.usc.cssl.nlputils.cluster.hierarchical.ui.internal.IHeirarchicalClusterViewConstants;
...
public class HierarchicalClusterView extends ViewPart implements
	...
	public static String ID = "edu.usc.cssl.nlputils.cluster.hierarchical.ui.view1";
		...
		Action helpAction = new Action() {
			...
			public void run() {
				PlatformUI
						...
						.getHelpSystem()
						.displayHelp(
								"edu.usc.cssl.nlputils.cluster.hierarchical.ui.hierarchical");
			};
		};
		mgr.add(helpAction);
		PlatformUI
