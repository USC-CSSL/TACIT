package edu.usc.cssl.nlputils.cluster.heirarchical.ui;
...
import edu.usc.cssl.nlputils.cluster.heirarchical.ui.internal.HeirarchicalClusterViewImageRegistry;
import edu.usc.cssl.nlputils.cluster.heirarchical.ui.internal.IHeirarchicalClusterViewConstants;
...
public class HeirarchicalClusterView extends ViewPart implements
		IHeirarchicalClusterViewConstants {
	public static String ID = "edu.usc.cssl.nlputils.cluster.heirarchical.ui.view1";
	...
	private void createAdditionalOptions(FormToolkit toolkit, Composite output) {
		Button spssRawFile = toolkit.createButton(output,
